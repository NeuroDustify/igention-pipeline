...
# Assuming 'generate_bin_data.py' is in the same directory
try:
    from smartbin_model.bin import bin
except ImportError:
    print("Error: Could not import bin.")
    print("Please ensure 'generate_bin_data.py' is in the same directory.")
    exit(1)
